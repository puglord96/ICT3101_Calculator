    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!endApp)
            {
                ...
                Console.WriteLine("\tf - Factorial of first number entered");
                Console.WriteLine("\tt - Area of triangle(height,length)");
                Console.WriteLine("\tc - Area of circle (with first number as radius)");
